...
select max(hor_log) from hora into @max;
delete from hora where hor_log = @max;
delete from hora where hor_log = @max - 1;
delete from hora where hor_log = @max - 2;
